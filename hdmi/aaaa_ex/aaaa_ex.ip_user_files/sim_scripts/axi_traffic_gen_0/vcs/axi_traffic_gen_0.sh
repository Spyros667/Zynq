...
design_libs=(xpm dist_mem_gen_v8_0_16 blk_mem_gen_v8_4_10 lib_bmg_v1_0_19 lib_cdc_v1_0_3 axi_traffic_gen_v3_0_20 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work dist_mem_gen_v8_0_16 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl/src/verilog" \
  "../../../ipstatic/simulation/dist_mem_gen_v8_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work blk_mem_gen_v8_4_10 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl/src/verilog" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vhdlan -work lib_bmg_v1_0_19 $vhdlan_opts \
  ...
  vhdlan -work axi_traffic_gen_v3_0_20 $vhdlan_opts \
  "../../../ipstatic/hdl/axi_traffic_gen_v3_0_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vlogan -work axi_traffic_gen_v3_0_20 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl/src/verilog" \
...
reset_run()
{
  files_to_remove=(ucli.key axi_traffic_gen_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_traffic_gen_0_simv.daidir vcs_lib c.obj)
