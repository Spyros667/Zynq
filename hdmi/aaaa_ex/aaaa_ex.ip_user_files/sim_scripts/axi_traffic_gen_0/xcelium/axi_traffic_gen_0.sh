...
#
# Script generated by Vivado on Mon Jan 13 17:25:03 EET 2025
...
#
# Usage        : axi_traffic_gen_0.sh
#                axi_traffic_gen_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_traffic_gen_0.sh [-reset_run]
#                axi_traffic_gen_0.sh [-reset_log]
#                axi_traffic_gen_0.sh [-help]
#
...
#                script (type 'axi_traffic_gen_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname dist_mem_gen_v8_0_16 -libname blk_mem_gen_v8_4_10 -libname lib_bmg_v1_0_19 -libname lib_cdc_v1_0_3 -libname axi_traffic_gen_v3_0_20 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm dist_mem_gen_v8_0_16 blk_mem_gen_v8_4_10 lib_bmg_v1_0_19 lib_cdc_v1_0_3 axi_traffic_gen_v3_0_20 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_traffic_gen_0.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_traffic_gen_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work dist_mem_gen_v8_0_16 $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" \
  "../../../ipstatic/simulation/dist_mem_gen_v8_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work blk_mem_gen_v8_4_10 $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvhdl -work lib_bmg_v1_0_19 -V93 $xmvhdl_opts \
  ...
  xmvhdl -work axi_traffic_gen_v3_0_20 -V93 $xmvhdl_opts \
  "../../../ipstatic/hdl/axi_traffic_gen_v3_0_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvlog -work axi_traffic_gen_v3_0_20 $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_traffic_gen_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_traffic_gen_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_traffic_gen_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: axi_traffic_gen_0.sh [-step]\n\
Usage: axi_traffic_gen_0.sh [-lib_map_path]\n\
Usage: axi_traffic_gen_0.sh [-reset_run]\n\
Usage: axi_traffic_gen_0.sh [-reset_log]\n\
Usage: axi_traffic_gen_0.sh [-keep_index]\n\
