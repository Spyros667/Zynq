...
#
# Script generated by Vivado on Mon Jan 13 17:25:02 EET 2025
...
#
# Usage        : aaaa.sh
#                aaaa.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                aaaa.sh [-reset_run]
#                aaaa.sh [-reset_log]
#                aaaa.sh [-help]
#
...
#                script (type 'aaaa.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname lib_pkg_v1_0_4 -libname lib_cdc_v1_0_3 -libname axi_lite_ipif_v3_0_4 -libname interrupt_control_v3_1_5 -libname axi_iic_v2_1_10 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm lib_pkg_v1_0_4 lib_cdc_v1_0_3 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_iic_v2_1_10 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "aaaa.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./aaaa.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work axi_iic_v2_1_10 -V93 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.aaaa xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.aaaa -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log aaaa_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./aaaa.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: aaaa.sh [-help]\n\
Usage: aaaa.sh [-step]\n\
Usage: aaaa.sh [-lib_map_path]\n\
Usage: aaaa.sh [-reset_run]\n\
Usage: aaaa.sh [-reset_log]\n\
Usage: aaaa.sh [-keep_index]\n\
Usage: aaaa.sh [-noclean_files]\n\n\
